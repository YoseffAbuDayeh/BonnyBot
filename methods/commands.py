...
class Command(commands.Cog):
    ...
    async def make(self, ctx):
        ...
        try:
            ...
            await new_text.send(
                "To add someone to this channel, use: ~add @user. This will add them to both the VC channel and this Text channel!")
            ...
            await ctx.send(
                f"So something happened... Ask a mod for help :)")  # BREAKING OUT OF CHARACTER IS UNACCEPTABLE!!!
